          ...
          <div className="prose max-w-none">
            ...
            <div className="mt-12 pt-8 border-t border-border">
              <p className="text-sm text-muted-foreground">
                <strong>About the Author:</strong> Shiv Shankar Tiwari is a Technical Leader with over six years of experience leading engineering teams in successful startups. 
                He specializes in building high-performing teams, making technical decisions, and delivering results that drive business success.
              </p>
            </div>
          </div>
        </article>
